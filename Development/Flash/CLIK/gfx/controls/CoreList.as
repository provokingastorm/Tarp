...
[InspectableList("disabled", "visible", "itemRenderer", "enableInitCallback", "inspectableRendererInstanceName", "soundMap", "bTriggerSoundsOnEvents")]
...
// Private Methods		
	...
	/** Helper function to set focusgroupmask for all components */
	public function SetFocusGroupMask(newMask:Number)
	{
		this.focusGroupMask = newMask;
		...
		for (var i:Number = 0; i < ArrayLength; i++)
		{
			...
			if (renderer != null) 
			{
				renderer.focusGroupMask = newMask;
			}
		}
	}
