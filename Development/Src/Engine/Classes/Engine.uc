...
/** Object used to interface with Facebook */
...
/** Triggers a call to GStreamingManager->StreamAllResources(TRUE) the next Tick, to stream all textures. */
var const transient bool bTriggerTextureStreaming;
...
/**
 * @return The (possibly NULL) Facebook integration object
 */
