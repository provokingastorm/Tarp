...
native(144) static final k2pure operator(16) int  *  ( int A, int B );
native(145) static final k2pure operator(16) int  /  ( int A, int B );
native(253) static final operator(18) int  %  ( int A, int B );
native(146) static final k2pure operator(20) int  +  ( int A, int B );
native(147) static final k2pure operator(20) int  -  ( int A, int B );
...
native(150) static final k2pure operator(24) bool <  ( int A, int B );
native(151) static final operator(24) bool >  ( int A, int B );
native(152) static final k2pure operator(24) bool <= ( int A, int B );
native(153) static final operator(24) bool >= ( int A, int B );
native(154) static final k2pure operator(24) bool == ( int A, int B );
...
native(167) static final k2pure Function     int  Rand  ( int Max );
...
native(171) static final k2pure operator(16) float *  ( float A, float B );
native(172) static final k2pure operator(16) float /  ( float A, float B );
native(173) static final operator(18) float %  ( float A, float B );
native(174) static final k2pure operator(20) float +  ( float A, float B );
native(175) static final k2pure operator(20) float -  ( float A, float B );
native(176) static final k2pure operator(24) bool  <  ( float A, float B );
native(177) static final operator(24) bool  >  ( float A, float B );
native(178) static final k2pure operator(24) bool  <= ( float A, float B );
native(179) static final operator(24) bool  >= ( float A, float B );
native(180) static final k2pure operator(24) bool  == ( float A, float B );
...
native(186) static final k2pure function	float Abs   ( float A );
native(187) static final k2pure function	float Sin   ( float A );
native      static final function	float Asin  ( float A );
native(188) static final k2pure function	float Cos   ( float A );
...
native(246) static final k2pure function	float FClamp( float V, float A, float B );
native(247) static final function	float Lerp  ( float A, float B, float Alpha );
native(199)	static final k2pure function	int   Round	( float A );
...
native(212) static final k2pure operator(16) vector *     ( vector A, float B );
native(213) static final k2pure operator(16) vector *     ( float A, vector B );
native(296) static final k2pure operator(16) vector *     ( vector A, vector B );
native(214) static final k2pure operator(16) vector /     ( vector A, float B );
native(215) static final k2pure operator(20) vector +     ( vector A, vector B );
native(216) static final k2pure operator(20) vector -     ( vector A, vector B );
...
native(225)		static final k2pure function	float	VSize		( vector A );
...
native(226)		static final k2pure function	vector	Normal		( vector A );
native			static final k2pure function	vector	VLerp		( vector A, vector B, float Alpha );
native(252)		static final k2pure function	vector	VRand		( );
...
native(229) static final k2pure function			GetAxes( rotator A, out vector X, out vector Y, out vector Z );
...
native(320) static final k2pure function	Rotator	RotRand( optional bool bRoll );
...
native(168) static final k2pure operator(40) string @  ( coerce string A, coerce string B );
